classdef SPectrA4App < handle
    ...
    properties (Constant)
        AppPathBase = {'/SPectrA4/code'};
        AppClass = 'SPectrA4App';
        Increment = 1;
        Decrement = 0;
        Version = '13a';
    end
    ...
    methods
        ...
        function startApp(obj)
            ...
            mlock;
            SPectrA4App.refcount(obj.Increment);
            ...
            existVal = exist(fullfile(pwd,'SPectrA_4')); %#ok<EXIST>
            ...
            if (doesShadowExist && ~pathOne.equals(pathTwo))
                % We are trying to execute the wrong SPectrA_4
                errordlg(message('MATLAB:apps:runapp:WrongEntryPoint', 'SPectrA_4').getString, ...
            ...
            if nargout(@SPectrA_4) == 0
                eval('SPectrA_4');
            else
                obj.AppHandle = eval('SPectrA_4');
            end
